...
public:
	...
	[[nodiscard]] bool isServerPaired(const std::array<std::byte, 16>& serverId) noexcept;
...
private:
	...
	ClientConfigStorage mClientConfigStorage;
	ClientSentFilesStorages mClientSentFilesStorage;
};
